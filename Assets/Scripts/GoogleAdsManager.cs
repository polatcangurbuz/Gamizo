...
public class GoogleAdsManager : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        MobileAds.Initialize(initStatus => {
            LoadBannerAd(); // açýlýr açýlmaz altta banner reklamý görmek istiyorsan aktif et
            LoadInterstitialAd();
    ...
    public void LoadBannerAd()
    {
        ...
        adRequest.Keywords.Add("unity-admop-sample");
    ...
    public void LoadInterstitialAd()
    {
        ...
        InterstitialAd.Load(interId, adRequest,
            (InterstitialAd ad, LoadAdError error) =>
            {
                ...
                InterstitalReloadHandler(_interstitialAd);
            });
    }
    ...
    private void InterstitalReloadHandler(InterstitialAd interstitialAd)
    {
        // Raised when the ad closed full screen content.
        interstitialAd.OnAdFullScreenContentClosed += () =>
        {
